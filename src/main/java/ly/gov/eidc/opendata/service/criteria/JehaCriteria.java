...
/**
 * Criteria class for the {@link ly.gov.eidc.opendata.domain.Jeha} entity. This class is used
 * in {@link ly.gov.eidc.opendata.web.rest.JehaResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /jehas?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class JehaCriteria implements Serializable, Criteria {
    ...
    public JehaCriteria(JehaCriteria other) {
    ...
    @Override
    public JehaCriteria copy() {
        return new JehaCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final JehaCriteria that = (JehaCriteria) o;
        return (
